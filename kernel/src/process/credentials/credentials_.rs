...
impl Credentials_ {
    ...
    pub(super) fn prepare_exec_cred(
        ...
        // `no_new_privs` suppresses file privileges, but a file capability xattr still clears
        // ambient capabilities on Linux.
        ...
        // Mirrors Linux's `has_fcap || id_changed` rule for ambient capabilities.
        ...
        let (permitted, effective) =
            self.calculate_capsets_for_exec(file_capabilities, exec_euid, ambient);
