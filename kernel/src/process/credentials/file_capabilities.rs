...
impl FileCapabilities {
    ...
    pub const MAX_XATTR_SIZE: usize = MAX_XATTR_CAPS_SIZE;
    ...
    /// Converts stored file capabilities to the initial user namespace's xattr representation.
    ///
    /// Linux exposes a V3 xattr owned by root as V2 when read from the initial user namespace.
    /// See Linux's `cap_inode_getsecurity`:
    /// <https://github.com/torvalds/linux/blob/980ab36ae5972c83f683b939e50c469c4947229e/security/commoncap.c#L389-L524>.
            ...
            VfsCapRevision::V3 => {
                ...
                if root_uid.is_root() {
                    let converted_header =
                        VfsCapRevision::V2 as u32 | (magic_etc & VFS_CAP_FLAGS_MASK);
